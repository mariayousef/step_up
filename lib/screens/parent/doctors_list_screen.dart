            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  return FadeInUp(
                    delay: Duration(milliseconds: 100 * index),
                    child: _buildDoctorCard(context, dummyDoctors[index]),
                  );
                },
                childCount: dummyDoctors.length,
              ),
            ),
          ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        final query = Uri.encodeComponent(doctor.clinicAddress);
